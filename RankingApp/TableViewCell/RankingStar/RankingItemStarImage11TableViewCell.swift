//
//  RankingItemStarImage11TableViewCell.swift
//  RankingApp
//
//  Created by 佐々木英彦 on 2020/02/18.
//  Copyright © 2020 Akihiko Sasaki. All rights reserved.
//

import UIKit

class RankingItemStarImage11TableViewCell: UITableViewCell {
...
//        parentView.layer.masksToBounds = true
    ...
    func setData(selectedIndexPath: Int, rankingViewModelData: RankingViewModel) {
        ...
        let rankinCellData = rankingViewModelData.rankingCellViewModelList[selectedIndexPath]
        // セルの各値をセットする
